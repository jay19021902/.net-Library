<%@ Page Title="" Language="VB" MasterPageFile="~/User/MasterPageUser.master" AutoEventWireup="false" CodeFile="userpendingrequest.aspx.vb" Inherits="User_userpendingrequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="style31" colspan="4" 
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style32">Pending 
            Requests :</span> &nbsp;</td>
    </tr>
    <tr>
        <td class="style14" colspan="4" style="border-style: none; vertical-align: top">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        AutoGenerateDeleteButton="True" DataKeyNames="requestid" Height="191px" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [requestid], [bookid], [bookname], [authorname], [booktype], [bookprice], [bookdesc], [requesttime], [bookimage] FROM [tblbookrequest]">
                    </asp:SqlDataSource>
            </td>
    </tr>
    <tr>
